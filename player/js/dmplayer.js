	...
	return function(e) {
		...
		function(e, t, n) {
			...
			console.log('%c页面加载完毕消耗了' + Math.round(performance.now() * 100) / 100 + 'ms',
				...
				console.log('%c555视频解析',
				'background:#fff;color:#FF0000;');
				console.log('%cwww.555jiexi.com',
				'background:#fff;color:#FF0000;text-shadow:0 0 2px #eee,0 0 3px #eee,0 0 3px #eee,0 0 2px #eee,0 0 3px #eee;');
			t.default = a.default
		},
		function(e, t) {},
		function(e, t, n) {
				...
				o = function() {
					...
					return a(e, [{
						...
						value: function() {
							...
							this.template.infoVersion.innerHTML = "1.0.0", this.template.infoType.innerHTML = this.player.type, this.template
